const steps = [
    { id: '1', name: 'Authentifizierung', href: '#', status: 'current' },
    { id: '2', name: 'Wahlentscheidung', href: '#', status: 'upcoming' },
    { id: '3', name: 'Stimmabgabe', href: '#', status: 'upcoming' },
  ]
          ...
          {steps.map((step, stepIdx) => (
            <li key={step.name} className="relative md:flex md:flex-1">
              {step.status === 'complete' ? (
                ...
                <a href={step.href} aria-current="step" className="flex items-center px-6 py-3 text-sm font-medium">
