...
export default function WarningDialogC({ title, message, confirmText, cancelText, onConfirm }: { title: string, message: string, confirmText: string, cancelText: string, onConfirm: () => void  }) {
