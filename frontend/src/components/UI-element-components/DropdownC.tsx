...
export default function DropdownC({dropdownData, dropDownFunction}: {
    ...
    return (
        <Menu as="div" className="w-52 relative inline-block text-left">
            ...
            <div>
                <MenuButton
                    className="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-medium text-gray-800 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
