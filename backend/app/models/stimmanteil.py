...
class Stimmanteil(BaseModel):
    ...
    absolute: StrictInt
    __properties: ClassVar[List[str]] = ["party", "share", "absolute"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of Stimmanteil from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of Stimmanteil from a dict"""
        if obj is None:
            return None
