...
class Abgeordneter(BaseModel):
    ...
    party: Optional[Partei] = None
    __properties: ClassVar[List[str]] = ["id", "name", "firstname", "profession", "yearOfBirth", "party"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of Abgeordneter from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of Abgeordneter from a dict"""
        if obj is None:
            return None
