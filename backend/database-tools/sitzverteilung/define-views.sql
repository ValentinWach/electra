CREATE OR REPLACE VIEW zweitstimmen_bundesland_partei_with_votes AS --Muss vor mat view berechnet werden
SELECT parteien_id, wahlen_id, bundeslaender_id, stimmen_sum
from zweitstimmen_bundesland_partei
where stimmen_sum > 0;

CREATE OR REPLACE VIEW zweitstimmen_bundesland_bundestags_parteien_with_votes AS --Muss vor mat view berechnet werden
...
CREATE OR REPLACE VIEW uv_2_sitzkontingente_landeslisten_erhoeht_basis AS
...
CREATE OR REPLACE VIEW sitze_nach_gewinnern_ohne_partei AS
...
CREATE OR REPLACE VIEW ov_2_sitzkontingente_bundesweit_erhoeht_basis AS
...
FROM uv_2_sitzkontingente_landeslisten_erhoeht_basis msa join zweitstimmen_partei zs on zs.wahlen_id = msa.wahl_id and zs.parteien_id = msa.partei_id
