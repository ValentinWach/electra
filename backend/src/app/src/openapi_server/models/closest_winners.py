...
class ClosestWinners(BaseModel):
    ...
    closest_winners: List[Abgeordneter] = Field(alias="closestWinners")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "closestWinners": [Abgeordneter.from_dict(_item) for _item in obj.get("closestWinners")] if obj.get("closestWinners") is not None else None
        })
        return _obj
